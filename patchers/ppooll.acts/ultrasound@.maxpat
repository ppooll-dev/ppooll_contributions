...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 0.0, 0.0, 92.046867370605469, 16.0 ],
					"varname" : "act",
					"viewvisibility" : 1
				}
...
, 			{
				"name" : "ultrasound_voice.maxpat",
				"bootpath" : "~/Documents/Max 9/Packages/ppooll_contributions/patchers/abstractions/ultrasound@",
				"patcherrelativepath" : "../abstractions/ultrasound@",
				"type" : "JSON",
				"implicit" : 1
			}
 ],
		"autosave" : 0,
		"bgcolor" : [ 0.701960784313725, 0.074509803921569, 0.290196078431373, 1.0 ]
	}
