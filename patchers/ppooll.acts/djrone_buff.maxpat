...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 140.0, 0.0, 137.0, 15.0 ],
					"varname" : "presets"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 98.0, 0.0, 42.0, 15.0 ],
					"varname" : "preset-ramp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 98.0, 112.0, 179.0, 53.0 ],
					"varname" : "ll.blues",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 397.0, 122.0, 170.0, 22.0 ],
					"text" : "actmaker djrone_buff@ ff9696",
					"varname" : "act"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 223.75, 181.0, 53.25, 19.0 ],
					"text" : "set deck",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"id" : "obj-32",
					"items" : [ "hl2_song1.mp3", ",", "sb1_10000_2", ",", "cooler talk.aiff" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 18.0, 243.0, 19.0 ],
					"pattrmode" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 244.0, 18.0, 30.0, 19.0 ],
					"textcolor" : [ 1.0, 0.588235, 0.588235, 1.0 ],
					"triangle" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 112.0, 97.0, 50.0 ],
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						"buffermenu" : [ "cooler talk.aiff" ],
						"master" : [ 0 ],
						"playback_speed" : [ 1.0 ],
						"pres_menu" : [ "_" ],
						"preset-ramp" : [ 0 ],
						"presets" : [ 1 ],
						"processing" : [ 0.484536082474227, 0.752577319587629, 0.391752577319588, 0.731958762886598 ],
						"tetris_menu" : [ "" ],
						"title_menu" : [ "clientwindow" ],
						"wf_end" : [ 4051.08333333333303 ],
						"wf_start" : [ 1678.8125 ]
					}
,
...
, 			{
				"box" : 				{
					...
					"pattrmode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 36.5, 4.0, 49.0, 22.0 ],
					"varname" : "title_menu"
				}
...
, 			{
				"box" : 				{
					...
					"pattrmode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 49.0, 0.0, 49.0, 22.0 ],
					"varname" : "tetris_menu"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 49.0, 14.0 ],
					"varname" : "master"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 293.5, 584.0, 70.0, 22.0 ],
									"text" : "mc.pack~ 2"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 43.0, 184.0, 55.0, 22.0 ],
													"text" : "pak 0. 0."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 48.0, 275.0, 83.0, 19.0 ],
													"text" : "scale 0 152 1.7 0."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 48.0, 304.0, 26.0, 19.0 ],
													"text" : "$1 5"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 48.0, 328.0, 51.0, 19.0 ],
													"text" : "line~"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "int", "int" ],
													"patching_rect" : [ 48.0, 244.0, 54.0, 19.0 ],
													"text" : "unpack 0 0"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 131.0, 407.0, 30.0, 30.0 ]
												}
...
,
									"patching_rect" : [ 133.5, 518.0, 35.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 180.0, 450.0, 24.0, 20.0 ],
									"text" : "x,y"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 293.5, 706.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 116.5, 603.5, 27.0, 19.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 151.5, 580.5, 26.0, 19.0 ],
									"text" : "$1 5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "bang" ],
									"patching_rect" : [ 151.5, 603.5, 39.0, 19.0 ],
									"text" : "line~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 116.5, 637.0, 27.0, 19.0 ],
									"text" : "*~"
								}
...
,
									"patching_rect" : [ 116.5, 663.0, 103.0, 19.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 545.666666666666629, 333.0, 101.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 210.5, 450.0, 57.0, 57.0 ]
								}
...
,
		...
		"bgcolor" : [ 1.0, 0.588235294117647, 0.588235294117647, 1.0 ]
	}
