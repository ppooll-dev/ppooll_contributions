{
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 165.0, 16.0, 20.0, 16.0 ],
                    "text": "trg",
                    "varname": "trig"
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 134.0, 16.0, 31.0, 16.0 ],
                    "slidermax": 0.3,
                    "slidermin": 0.02,
                    "varname": "tol"
                }
            },
            {
                "box": {
                    ...
                    "outputmode": 0,
                    "parameter_enable": 0,
                    "patching_rect": [ 150.0, 0.0, 35.0, 16.0 ],
                    "text": "mask",
                    "texton": "mask",
                    "varname": "mask"
                }
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 119.0, 0.0, 30.0, 16.0 ],
                    "sliderlog": 4.0,
                    "slidermax": 5000.0,
                    "varname": "zoom_ramp"
                }
            },
            {
                "box": {
                    ...
                    "outputmode": 0,
                    "parameter_enable": 0,
                    "patching_rect": [ 62.0, 0.0, 21.0, 16.0 ],
                    "text": "off",
                    "texton": "on",
                    "varname": "world"
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 82.0, 0.0, 20.0, 16.0 ],
                    "text": "get",
                    "varname": "get_list"
                }
            },
            ...
            },
            {
                "box": {
                    ...
                    "outputmode": 0,
                    "parameter_enable": 0,
                    "patching_rect": [ 102.0, 0.0, 17.0, 16.0 ],
                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "text": "jit_gl_texture u371010216"
                                }
                            },
                            {
                                "box": {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 426.0, 429.0, 87.0, 22.0 ],
                                    "text": "s #0dim_in"
                                }
                            },
                            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 0,
                    "offset": [ 0.0, 0.0 ],
                    "patching_rect": [ 0.0, 0.0, 62.041011810302734, 16.0 ],
                    "varname": "act",
                    "viewvisibility": 1
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 473.0, 39.0, 100.0, 20.0 ],
        ...
        "bgcolor": [ 0.5333333333333333, 0.4666666666666667, 0.9333333333333333, 1.0 ]
    }
}