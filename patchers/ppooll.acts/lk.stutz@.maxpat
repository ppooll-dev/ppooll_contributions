...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 201.0, 120.0, 66.0, 22.0 ],
									"text" : "ll.r in_mix~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 201.0, 366.0, 68.0, 22.0 ],
									"text" : "ll.pf ll.blues"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 493.0, 113.0, 57.0, 22.0 ],
									"text" : "ll.r speed"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 426.0, 113.0, 45.0, 22.0 ],
									"text" : "ll.r rate"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 426.0, 148.0, 31.0, 20.0 ],
									"text" : "rate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 493.0, 213.0, 66.0, 22.0 ],
									"text" : "phasor~ 2."
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 493.0, 170.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 426.0, 213.0, 66.0, 22.0 ],
									"text" : "phasor~ 2."
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 201.0, 157.0, 74.0, 22.0 ],
									"text" : "mc.unpack~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 359.0, 263.0, 153.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 201.0, 331.0, 60.0, 22.0 ],
									"text" : "mc.pack~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 201.0, 263.0, 153.0, 22.0 ],
									"text" : "stutter~ 44100 22050 -1 10"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-8", 0 ],
									"midpoints" : [ 265.5, 220.5, 368.5, 220.5 ],
									"source" : [ "obj-10", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 1 ],
									"midpoints" : [ 435.5, 248.5, 277.5, 248.5 ],
									"order" : 1,
									"source" : [ "obj-12", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 2 ],
									"midpoints" : [ 502.5, 248.5, 344.5, 248.5 ],
									"order" : 1,
									"source" : [ "obj-13", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-7", 1 ],
									"midpoints" : [ 368.5, 307.5, 251.5, 307.5 ],
									"source" : [ "obj-8", 0 ]
								}
