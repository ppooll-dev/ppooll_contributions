...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 45.0, 158.75, 15.0 ],
					"slidermax" : 4.0,
					"varname" : "speed"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 31.0, 158.75, 15.0 ],
					"slidermax" : 32.0,
					"varname" : "rate"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 339.0, 27.0, 57.0, 22.0 ],
									"text" : "ll.r speed"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 272.0, 27.0, 45.0, 22.0 ],
									"text" : "ll.r rate"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 272.0, 62.0, 31.0, 20.0 ],
									"text" : "rate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 339.0, 127.0, 66.0, 22.0 ],
									"text" : "phasor~ 2."
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 339.0, 84.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 272.0, 127.0, 66.0, 22.0 ],
									"text" : "phasor~ 2."
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 272.0, 84.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 47.0, 71.0, 74.0, 22.0 ],
									"text" : "mc.unpack~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 205.0, 177.0, 153.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 47.0, 245.0, 60.0, 22.0 ],
									"text" : "mc.pack~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 47.0, 177.0, 153.0, 22.0 ],
									"text" : "stutter~ 44100 22050 -1 10"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 47.0, 325.0, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-8", 0 ],
									"midpoints" : [ 111.5, 134.5, 214.5, 134.5 ],
									"source" : [ "obj-10", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 1 ],
									"midpoints" : [ 281.5, 162.5, 123.5, 162.5 ],
									"order" : 1,
									"source" : [ "obj-12", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 2 ],
									"midpoints" : [ 348.5, 162.5, 190.5, 162.5 ],
									"order" : 1,
									"source" : [ "obj-13", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-7", 1 ],
									"midpoints" : [ 214.5, 221.5, 97.5, 221.5 ],
									"source" : [ "obj-8", 0 ]
								}
...
,
					"patching_rect" : [ 437.0, 286.0, 75.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.25, 16.0, 153.5, 15.0 ],
					"varname" : "presets"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 0.0, 72.0, 159.0, 53.0 ],
					"varname" : "ll.blues",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 0.0, 60.0, 160.0, 12.0 ],
					"varname" : "ll.inputmix",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"text" : "actmaker lk.stutz@ \"100 80 100\"",
					"varname" : "act"
				}
...
, 			{
		...
		"autosave" : 0,
		"bgcolor" : [ 0.392156862745098, 0.313725490196078, 0.392156862745098, 1.0 ]
	}
