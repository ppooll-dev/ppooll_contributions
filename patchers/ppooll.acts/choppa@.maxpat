...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 170.0, 117.0, 19.0 ],
					"pattrmode" : 1,
					"varname" : "mode1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 71.0, 0.0, 46.0, 16.0 ],
					"sliderlog" : 3.0,
					"slidermax" : 20000.0,
					"varname" : "preset-ramp"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 16.0, 117.0, 27.0 ],
					"varname" : "presets"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 149.0, 117.0, 21.0 ],
					"slidermax" : 100.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 128.0, 117.0, 21.0 ],
					"slidermax" : 40.0,
					"slidermin" : 1.0,
					"textcolornofocus" : [ 0.235294117647059, 0.0, 0.0, 0.788235294117647 ],
					"varname" : "repeat1"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 107.0, 117.0, 21.0 ],
					"slidermax" : 120.0,
					"slidermin" : 1.0,
					"textcolornofocus" : [ 0.235294117647059, 0.0, 0.0, 0.788235294117647 ],
					"varname" : "max1"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 86.0, 117.0, 21.0 ],
					"slidermax" : 100.0,
					"slidermin" : 0.25,
					"textcolornofocus" : [ 0.235294117647059, 0.0, 0.0, 0.788235294117647 ],
					"varname" : "min1"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 65.0, 117.0, 21.0 ],
					"slidermax" : 150.0,
					"slidermin" : 1.0,
					"textcolornofocus" : [ 0.235294117647059, 0.0, 0.0, 0.788235294117647 ],
					"varname" : "cross1"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 44.0, 117.0, 21.0 ],
					"slidermax" : 30.0,
					"slidermin" : 0.01,
					"textcolornofocus" : [ 0.235294117647059, 0.0, 0.0, 0.788235294117647 ],
					"varname" : "rate1"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 282.0, 32.0, 95.0, 22.0 ],
					"restore" : [ "0(1)", "in(1)" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 0.0, 189.0, 117.0, 53.0 ],
					"varname" : "ll.blues",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 282.0, 101.0, 159.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 44.0, 648.0, 68.0, 22.0 ],
									"text" : "ll.pf ll.blues"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 44.0, 88.0, 51.0, 22.0 ],
									"text" : "ll.r~ in 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 653.0, 533.0, 50.0, 22.0 ],
									"text" : "0.1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 629.0, 322.0, 50.0, 22.0 ],
									"text" : "1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 525.0, 340.0, 52.0, 22.0 ],
									"text" : "1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 44.0, 618.0, 60.0, 22.0 ],
									"text" : "mc.pack~"
								}
...
,
					"patching_rect" : [ 202.0, 97.0, 73.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 282.0, 59.0, 113.0, 22.0 ],
...
,
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 295.0, 80.0, 100.0, 22.0 ],
					"priority" : 					{
						"title_menu" : 2010,
						"pres_menu" : 2011,
						"tetris_menu" : 2012,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 282.0, 122.0, 107.0, 22.0 ],
					"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ],
					"text" : "thispatcher",
					"varname" : "thispatcher"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 282.0, 143.0, 107.0, 22.0 ],
					"text" : "pattrmarker no",
					"varname" : "pattrmarker"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 282.0, 164.0, 107.0, 22.0 ],
					"restore" : 					{
						"blend1" : [ 0.1 ],
						"cross1" : [ 1.0 ],
						"master" : [ 0, 0 ],
...
, 			{
				...
				"bootpath" : "~/Documents/Max 8/Packages/ppooll_contributions/patchers/abstractions/chopper",
				"patcherrelativepath" : "../abstractions/chopper",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
