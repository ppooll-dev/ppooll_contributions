...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 761.0, 163.199999999999989, 96.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 572.0, 224.799999999999983, 118.0, 22.0 ],
					"text" : "prepend max_length"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 514.0, 163.199999999999989, 77.0, 22.0 ],
					"text" : "mstosamps~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 448.5, 224.799999999999983, 115.0, 22.0 ],
					"text" : "prepend min_length"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 390.5, 163.199999999999989, 77.0, 22.0 ],
					"text" : "mstosamps~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "", "", "", "", "", "", "" ],
					"patching_rect" : [ 143.5, 101.599999999999994, 760.0, 22.0 ],
					"text" : "route rate cross min max mode repeats",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 97.0, 80.48640167364016, 89.0, 22.0 ],
									"text" : "pitchedmode 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 23.0, 80.48640167364016, 61.0, 22.0 ],
									"text" : "capture 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 23.0, 26.0, 60.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 23.0, 134.972803347280319, 30.0, 30.0 ]
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"midpoints" : [ 32.5, 63.743200836820066, 106.5, 63.743200836820066 ],
									"order" : 0,
									"source" : [ "obj-15", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 32.5, 64.657949790794959, 32.5, 64.657949790794959 ],
									"order" : 1,
									"source" : [ "obj-15", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 106.5, 118.229602510460225, 32.5, 118.229602510460225 ],
									"source" : [ "obj-16", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-18", 0 ],
									"midpoints" : [ 32.5, 117.926778242677813, 32.5, 117.926778242677813 ],
									"source" : [ "obj-17", 0 ]
								}
...
,
					"patching_rect" : [ 75.0, 163.199999999999989, 41.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 637.5, 163.199999999999989, 108.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 13.0, 688.0, 37.0, 22.0 ],
									"text" : "out 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 13.0, 18.0, 198.0, 22.0 ],
...
,
					"patching_rect" : [ 39.0, 286.399999999999977, 77.0, 22.0 ],
					"text" : "gen~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 267.0, 163.199999999999989, 107.0, 22.0 ],
					"text" : "prepend crossings"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 143.5, 163.199999999999989, 77.0, 22.0 ],
					"text" : "prepend rate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 39.0, 379.0, 60.0, 20.0 ],
					"text" : "audio out"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 143.5, 40.0, 30.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 39.0, 40.0, 37.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 39.0, 348.0, 44.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"patchline" : 				{
					"color" : [ 0.0, 0.0, 0.0, 1.0 ],
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 647.0, 204.5, 48.5, 204.5 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.0, 0.0, 0.0, 1.0 ],
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 153.0, 204.5, 48.5, 204.5 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.0, 0.0, 0.0, 1.0 ],
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 84.5, 204.5, 48.5, 204.5 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.0, 0.0, 0.0, 1.0 ],
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 276.5, 204.5, 48.5, 204.5 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.0, 0.0, 0.0, 1.0 ],
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 770.5, 266.099999999999966, 48.5, 266.099999999999966 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.0, 0.0, 0.0, 1.0 ],
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 458.0, 266.099999999999966, 48.5, 266.099999999999966 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.0, 0.0, 0.0, 1.0 ],
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 581.5, 266.099999999999966, 48.5, 266.099999999999966 ],
					"source" : [ "obj-9", 0 ]
				}
